...
**MPR File:** C:/Workspaces/Mendix/MDUI/FN/MX_OC_EX_System/OC EX System.mpr  
**Generated:** 2026-05-27 16:07:35  
...
- **Signal Manager Subscriptions:** 2 subscription(s)
- **Navigation Items:** 10
- **Pages with Commands:** 9 page(s) analyzed
- **Command Buttons:** 60 total, 49 with extracted commands
- **Pages with Entity Datasources:** 15 page(s)
...
Found commands in 9 page(s):

### OpcenterEXFN_ReferenceData.Counter_Master

| Caption | Target Page | Target AppName | Target CommandName |
|---------|-------------|----------------|--------------------|
| Create | OpcenterEXFN_ReferenceData.PANEL_CreateCounter | - | CreateCounter |
| Open | OpcenterEXFN_ReferenceData.Counter_Details | - | - |
| Edit | OpcenterEXFN_ReferenceData.PANEL_UpdateCounter | - | UpdateCounter |
| Hide  | - | - | - |
| Unhide  | - | - | - |
| Freeze | - | - | FreezeCounter |
| Unfreeze | - | - | UnfreezeCounter |
| Reset  | - | - | - |
| Delete | - | - | DeleteCounter |

### OpcenterEXFN_ReferenceData.NumberingPattern_Master

| Caption | Target Page | Target AppName | Target CommandName |
|---------|-------------|----------------|--------------------|
| Create | OpcenterEXFN_ReferenceData.PANEL_CreateNumberingPattern | - | CreateNumberingPattern |
| Details | OpcenterEXFN_ReferenceData.NumberingPattern_Details | - | - |
| Edit | OpcenterEXFN_ReferenceData.PANEL_UpdateNumberingPattern | - | UpdateNumberingPattern |
| Freeze | - | - | FreezeNumberingPattern |
| Unfreeze | - | - | UnfreezeNumberingPattern |
| Preview | OpcenterEXFN_ReferenceData.PANEL_PreviewNumberingPattern | - | - |
| Delete | - | - | DeleteNumberingPattern |
...
### OpcenterEXFN_ReferenceData.UoM_Master

| Caption | Target Page | Target AppName | Target CommandName |
|---------|-------------|----------------|--------------------|
| Create | OpcenterEXFN_ReferenceData.PANEL_CreateBaseUoM | - | CreateBaseUoM |
| Details | OpcenterEXFN_ReferenceData.UoM_Details | - | - |
| Edit | OpcenterEXFN_ReferenceData.PANEL_UpdateUoM | - | UpdateUoM |
| Unhide | - | - | UnhideUoM |
| Hide | - | - | HideUoM |
| Delete | - | - | DeleteUoM |
...
pages:
  ...
  - name: PANEL_UpdateUoMFactor
    module: OpcenterEXFN_ReferenceData
    flows:
      - name: OpcenterEXFN_ReferenceData.ACT_UpdateUoMFactor
        calls:
...
| PANEL_UpdateUoMFactor | OpcenterEXFN_ReferenceData | Reference | UpdateUoMFactor |
...
| Counter_Master | OpcenterEXFN_ReferenceData | Reference<br>Reference<br>Reference<br>Reference<br>Reference<br>Reference | HideCounter<br>UnhideCounter<br>FreezeCounter<br>UnfreezeCounter<br>ResetCounter<br>DeleteCounter |
...
| Counter_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.Counter |
| NumberingPattern_Details | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.NumberingPatternPart |
| NumberingPattern_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.NumberingPattern |
| StateMachine_Details | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.Status<br>OpcenterEXFN_ReferenceData.StatusTransition |
| StateMachine_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.StateMachine |
| StatusBehaviorDefinition_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.StatusBehaviorDefinition |
| StatusDefinition_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.StatusDefinition |
| StatusTransitionDefinition_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.StatusTransitionDefinition |
| Status_Details | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.StatusBehaviorDefinition |
| Status_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.Status |
| UoMDimension_Details | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.UoM |
| UoMDimension_Master_SingleSelection | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.UoMDimension |
| UoM_Details | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.UoM |
| UoM_Master | OpcenterEXFN_ReferenceData | OpcenterEXFN_ReferenceData.UoM |
